 ...
 */
/**
 * Mint one RFC 4122 version 4 UUID via getRandomValues, which — unlike
 * `crypto.randomUUID` — also exists on insecure origins (browser bundles
 * served over plain LAN HTTP).
 */
